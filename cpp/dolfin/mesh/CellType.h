...
public:
  ...
  virtual double squared_distance(const Cell& cell,
                                  const EigenPointVector& point) const = 0;
  ...
  virtual EigenPointVector normal(const Cell& cell, std::size_t facet) const = 0;

  /// Compute normal to given cell (viewed as embedded in 3D)
  virtual EigenPointVector cell_normal(const Cell& cell) const = 0;
